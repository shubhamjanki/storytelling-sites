      ...
      <div className="container relative z-10 mx-auto px-6 pt-28 md:pt-32">
        <AnimatePresence>
          ...
          <>
              ...
              {/* Text + Portrait stack */}
              <div className="relative flex flex-col items-center rounded-sm shadow-md">
                <motion.h1
                {...fadeUp(0.08)}
                ...
                className="relative z-[15] mx-auto -mt-8 sm:-mt-12 md:-mt-16 lg:-mt-24 w-64 sm:w-72 md:w-80 lg:w-96 pointer-events-none">
                  ...
                  className="relative z-10 w-full object-contain drop-shadow-[0_20px_40px_hsl(var(--neon)/0.3)] grayscale [mask-image:radial-gradient(ellipse_60%_55%_at_50%_40%,black_50%,transparent_90%)]" />
